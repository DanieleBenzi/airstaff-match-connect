        ...
        <section className="py-16 px-6 md:px-12 lg:px-24 bg-gradient-to-r from-gray-50 to-gray-100">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-12 max-w-3xl mx-auto">
              Non riesci a trovare il lavoratore giusto? Con AirStaff puoi aprire una posizione (utilizzando il form qui sotto) e saremo noi a <strong>cercare gratuitamente</strong> per te il lavoratore.<br />
              Come lo faremo? contatteremo le Agenzie del Lavoro presenti nel nostro circuito e condivideremo la tua richiesta. A te non resta che attendere. Non è richiesta nemmeno l'<strong>apertura di un account</strong>, ci basta una tua email!
              <br /><br />
