      ...
      <div className="container mx-auto max-w-5xl bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl shadow-xl overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center">
          ...
          <div className="hidden md:block h-full">
            <img alt="Interfaccia piattaforma AirStaff per la ricerca di lavoratori tramite agenzie per il lavoro" className="h-full w-full object-cover" loading="lazy" src="/lovable-uploads/f6d3364e-be08-46ee-86b1-60df40371ea8.png" />
          </div>
        </div>
      </div>
    </section>;
