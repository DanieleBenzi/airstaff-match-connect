  ...
  return <section className="px-6 md:px-12 lg:px-24 bg-gray-50 py-[30px]">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <FeatureCard icon={<Users size={24} />} title="Apri una posizione" description="Non trovi il lavoratore giusto per te? Nessun problema, dicci cosa ti serve e noi lo giriamo al nostro network di APL." />
          <FeatureCard icon={<Bell size={24} />} title="Alert automatici" description="Ricevi notifiche automatiche quando nuovi lavoratori sono disponibili." />
        </div>
      </div>
    </section>;
};
