...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description }) => {
  return (
    <div className="p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow bg-white">
    ...
    <section className="py-20 px-6 md:px-12 lg:px-24">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <FeatureCard 
            icon={<Brain size={24} />}
            title="Ricerca avanzata basata sull'intelligenza artificiale"
            description="Ricerca oltre che per ruolo anche per competenze, CCNL e disponibilità."
          />
          <FeatureCard 
            icon={<TrendingUp size={24} />}
            title="Lead tracking integrati"
            description="Monitora e gestisci tutte le tue richieste di personale in un'unica dashboard."
          />
          <FeatureCard 
            icon={<Users size={24} />}
